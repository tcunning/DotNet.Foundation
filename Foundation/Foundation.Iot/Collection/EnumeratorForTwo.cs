...
public struct EnumeratorForTwo<TValue> : IEnumerator<TValue>, ITypeSideOf
    where TValue : struct
{
    [RequiresPreviewFeatures]
    public static int TypeSizeOf => 2;
    ...
    public TValue[] ToArray() => new[] { _value0, _value1 };

    /// <summary>
    /// Create a new list with all values
    /// </summary>
    /// <returns>Array with all values</returns>
    public List<TValue> ToList() => new(_tracker.Count) { _value0, _value1 };
