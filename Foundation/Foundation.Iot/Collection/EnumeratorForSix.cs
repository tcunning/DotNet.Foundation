...
public struct EnumeratorForSix<TValue> : IEnumerator<TValue>
    where TValue : struct
{
    ...
    public EnumeratorForSix(TValue value0, TValue value1, TValue value2, TValue value3, TValue value4, TValue value5)
    {
    ...
    public TValue[] ToArray() => new[] { _value0, _value1, _value2, _value3, _value4, _value5 };

    /// <summary>
    /// Create a new list with all values
    /// </summary>
    /// <returns>Array with all values</returns>
    public List<TValue> ToList() => new(_tracker.Count) { _value0, _value1, _value2, _value3, _value4, _value5 };
