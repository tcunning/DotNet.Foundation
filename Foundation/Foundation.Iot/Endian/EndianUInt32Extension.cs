...
{
    /// <summary>
    /// Creates a <see cref="EndianUInt32"/> from the given value that will use the <see cref="EndianFormat"/>
    /// for endian conversions.
    /// <example>
    /// <code>
    /// UInt32 value = 0x12345678;
    /// var endianValue = value.AsEndianUInt32(EndianFormat.Big);
    /// </code>
    /// </example>
    /// </summary>
    ...
    /// <summary>
    /// Creates a <see cref="EndianUInt32"/> from the given buffer that uses the <see cref="EndianFormat"/>
    /// for conversions.
    /// <example>
    /// <code>
    /// var buffer = new byte[] { 0xFF, 0x12, 0x34, 0x56, 0x78, 0xFF };
    /// var bufferSegment = new ArraySegment&lt;byte&gt;(buffer, 1, 4);
    /// var endianValue = bufferSegment.AsEndianUInt32(EndianFormat.Big);
    /// </code>
    /// </example>
    /// </summary>
    ...
    /// <returns>The <see cref="EndianUInt32"/> that reads the given buffer that is in <see cref="EndianFormat"/></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EndianUInt32 AsEndianUInt32(this ArraySegment<byte> buffer, EndianFormat endianFormat) =>
    ...
    /// var endianValue = buffer.AsEndianUInt32(EndianFormat.Big, startIndex: 1);
    /// </code>
    /// </example>
    /// </summary>
    /// <param name="buffer">A buffer in the form of an array segment that is used as the source of the endian value</param>
    ...
    /// <returns>The <see cref="EndianUInt32"/> that reads the given buffer that is in <see cref="EndianFormat"/></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EndianUInt32 AsEndianUInt32(this byte[] buffer, EndianFormat endianFormat, int startIndex = 0) =>
        new (new ArraySegment<byte>(buffer, startIndex, sizeof(UInt32)), endianFormat);
    ...
    /// <param name="endianFormat">The endian format of the data used to determine how to interpret the bytes in the buffer</param>
    /// <param name="startIndex">The starting index within the given buffer to start using to make the endian value</param>
    /// <returns>The <see cref="EndianUInt32"/> that reads the given buffer that is in <see cref="EndianFormat"/> starting
    /// at the given <see cref="startIndex"/></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UInt32 AsUInt32(this byte[] buffer, EndianFormat endianFormat, int startIndex = 0) =>
        AsEndianUInt32(buffer, endianFormat, startIndex).Value;
    ...
    /// value.CopyToBuffer(EndianFormat.Big, 0, buffer, 0, sizeof(UInt32));
    /// </code>
    /// </example>
    /// </summary>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CopyToBuffer(this UInt32 value, EndianFormat endianFormat, int sourceStartIndex, byte[] destinationArray, int destinationStartIndex, int count) =>
        AsEndianUInt32(value, endianFormat).CopyTo(sourceStartIndex, destinationArray, destinationStartIndex, count);
    ...
    /// <param name="destinationStartIndex">Index in the destination buffer were the copy should be started</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CopyToBuffer(this UInt32 value, EndianFormat endianFormat, byte[] destinationArray, int destinationStartIndex = 0) =>
        AsEndianUInt32(value, endianFormat).CopyTo(destinationArray, destinationStartIndex);
}