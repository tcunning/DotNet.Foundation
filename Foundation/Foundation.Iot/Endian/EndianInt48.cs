...
/// </para>
/// <para>There are also several extension methods, <see cref="EndianInt48Extension"/> that make this "easier" to use for
...
public readonly ref struct EndianInt48
{
    ...
    public EndianInt48(ArraySegment<byte> buffer, EndianFormat endianFormat) : this(MakeValue(buffer, endianFormat), endianFormat)
    {
    }
