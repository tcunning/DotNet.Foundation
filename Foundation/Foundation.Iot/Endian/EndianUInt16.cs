...
/// </para>
/// <para>There are also several extension methods, <see cref="EndianUInt16Extension"/> that make this "easier" to use for
...
public readonly ref struct EndianUInt16
{
    ...
    public byte this[int index]
    {
        get
        {
            ...
            return (byte) ((Value >> EndianValueManipulation<UInt16, TypeSizeOfValue2Bytes>.BitsToShift(EndianFormat, index)) & Byte.MaxValue);
        }
    }
    ...
    public EndianUInt16(ArraySegment<byte> buffer, EndianFormat endianFormat) : this(MakeValue(buffer, endianFormat), endianFormat)
    {
    }
